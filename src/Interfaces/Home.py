...
class win_Home:
	# Function to log user out of interface and return them to login screen
	def logout(self):
	...
	#Function to redirect user to user management window
	def users(self):
		if(usertype=="user"):
	...
	def __init__(self, top=None):
		...
		self.btnListIP.configure(command=lambda: Home_support.create_ip_list())
		...
		self.btnLogging.configure(command=lambda: Home_support.create_logs())
		...
		self.btnMetrics.configure(command=lambda: Metrics.execute())
