...
; <label>:40:                                     ; preds = %37
  ...
  %71 = getelementptr i8, i8* %29, i64 54
  %72 = icmp ugt i8* %71, %25
  br i1 %72, label %667, label %73

; <label>:73:                                     ; preds = %40
  %74 = call i8* inttoptr (i64 1 to i8* (i8*, i8*)*)(i8* bitcast (%struct.bpf_map_def* @blacklist to i8*), i8* nonnull %20) #2
...
; <label>:77:                                     ; preds = %73
  ...
  %80 = bitcast %struct.log* %13 to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %80) #2
  %81 = getelementptr inbounds %struct.log, %struct.log* %13, i64 0, i32 4, i64 0
  %82 = bitcast i8* %81 to i64*
  store i64 0, i64* %82, align 4
  %83 = load i32, i32* %10, align 4, !tbaa !16
  %84 = getelementptr inbounds %struct.log, %struct.log* %13, i64 0, i32 0
  store i32 %83, i32* %84, align 4, !tbaa !18
  %85 = getelementptr inbounds %struct.log, %struct.log* %13, i64 0, i32 1
  store i32 2, i32* %85, align 4, !tbaa !20
  %86 = getelementptr inbounds %struct.log, %struct.log* %13, i64 0, i32 2
  store i32 1, i32* %86, align 4, !tbaa !21
  %87 = getelementptr inbounds %struct.log, %struct.log* %13, i64 0, i32 3
  store i32 %48, i32* %87, align 4, !tbaa !22
  %88 = load i8, i8* %56, align 1, !tbaa !23
  %89 = getelementptr inbounds %struct.log, %struct.log* %13, i64 0, i32 4, i64 0
  store i8 %88, i8* %89, align 4, !tbaa !23
  %90 = getelementptr inbounds %struct.ethhdr, %struct.ethhdr* %30, i64 0, i32 0, i64 1
  %91 = load i8, i8* %90, align 1, !tbaa !23
  %92 = getelementptr inbounds %struct.log, %struct.log* %13, i64 0, i32 4, i64 1
  store i8 %91, i8* %92, align 1, !tbaa !23
  %93 = getelementptr inbounds %struct.ethhdr, %struct.ethhdr* %30, i64 0, i32 0, i64 2
  %94 = load i8, i8* %93, align 1, !tbaa !23
  %95 = getelementptr inbounds %struct.log, %struct.log* %13, i64 0, i32 4, i64 2
  store i8 %94, i8* %95, align 2, !tbaa !23
  %96 = getelementptr inbounds %struct.ethhdr, %struct.ethhdr* %30, i64 0, i32 0, i64 3
  %97 = load i8, i8* %96, align 1, !tbaa !23
  %98 = getelementptr inbounds %struct.log, %struct.log* %13, i64 0, i32 4, i64 3
  store i8 %97, i8* %98, align 1, !tbaa !23
  %99 = getelementptr inbounds %struct.ethhdr, %struct.ethhdr* %30, i64 0, i32 0, i64 4
  %100 = load i8, i8* %99, align 1, !tbaa !23
  %101 = getelementptr inbounds %struct.log, %struct.log* %13, i64 0, i32 4, i64 4
  store i8 %100, i8* %101, align 4, !tbaa !23
  %102 = getelementptr inbounds %struct.ethhdr, %struct.ethhdr* %30, i64 0, i32 0, i64 5
  %103 = load i8, i8* %102, align 1, !tbaa !23
  %104 = getelementptr inbounds %struct.log, %struct.log* %13, i64 0, i32 4, i64 5
  store i8 %103, i8* %104, align 1, !tbaa !23
  %105 = call i64 inttoptr (i64 5 to i64 ()*)() #2
  store i64 %105, i64* %11, align 8, !tbaa !2
  %106 = call i32 inttoptr (i64 2 to i32 (i8*, i8*, i8*, i64)*)(i8* bitcast (%struct.bpf_map_def* @logs to i8*), i8* nonnull %21, i8* nonnull %80, i64 0) #2
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %80) #2
  br label %667

; <label>:107:                                    ; preds = %73
  %108 = call i8* inttoptr (i64 1 to i8* (i8*, i8*)*)(i8* bitcast (%struct.bpf_map_def* @ip_watchlist to i8*), i8* nonnull %20) #2
  %109 = bitcast i8* %108 to i64*
  %110 = icmp eq i8* %108, null
  br i1 %110, label %114, label %111

; <label>:111:                                    ; preds = %107
  %112 = load i64, i64* %109, align 8, !tbaa !2
  %113 = add i64 %112, 1
  store i64 %113, i64* %109, align 8, !tbaa !2
  br label %116

; <label>:114:                                    ; preds = %107
  %115 = call i32 inttoptr (i64 2 to i32 (i8*, i8*, i8*, i64)*)(i8* bitcast (%struct.bpf_map_def* @ip_watchlist to i8*), i8* nonnull %20, i8* nonnull %19, i64 1) #2
  br label %116

; <label>:116:                                    ; preds = %114, %111
  %117 = getelementptr inbounds i8, i8* %29, i64 23
  %118 = load i8, i8* %117, align 1, !tbaa !24
  %119 = icmp eq i8 %118, 6
  br i1 %119, label %143, label %120

; <label>:120:                                    ; preds = %116
  %121 = bitcast %struct.log* %14 to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %121) #2
  %122 = getelementptr inbounds %struct.log, %struct.log* %14, i64 0, i32 4, i64 0
  %123 = bitcast i8* %122 to i64*
  store i64 0, i64* %123, align 4
  %124 = load i32, i32* %10, align 4, !tbaa !16
  %125 = getelementptr inbounds %struct.log, %struct.log* %14, i64 0, i32 0
  store i32 %124, i32* %125, align 4, !tbaa !18
  %126 = getelementptr inbounds %struct.log, %struct.log* %14, i64 0, i32 1
  store i32 1, i32* %126, align 4, !tbaa !20
  %127 = getelementptr inbounds %struct.log, %struct.log* %14, i64 0, i32 2
  store i32 4, i32* %127, align 4, !tbaa !21
  %128 = getelementptr inbounds %struct.log, %struct.log* %14, i64 0, i32 3
  store i32 %48, i32* %128, align 4, !tbaa !22
  %129 = load i8, i8* %56, align 1, !tbaa !23
  %130 = getelementptr inbounds %struct.log, %struct.log* %14, i64 0, i32 4, i64 0
  store i8 %129, i8* %130, align 4, !tbaa !23
  %131 = load i8, i8* %56, align 1, !tbaa !23
  %132 = getelementptr inbounds %struct.log, %struct.log* %14, i64 0, i32 4, i64 1
  store i8 %131, i8* %132, align 1, !tbaa !23
  %133 = load i8, i8* %56, align 1, !tbaa !23
  %134 = getelementptr inbounds %struct.log, %struct.log* %14, i64 0, i32 4, i64 2
  store i8 %133, i8* %134, align 2, !tbaa !23
  %135 = load i8, i8* %56, align 1, !tbaa !23
  %136 = getelementptr inbounds %struct.log, %struct.log* %14, i64 0, i32 4, i64 3
  store i8 %135, i8* %136, align 1, !tbaa !23
  %137 = load i8, i8* %56, align 1, !tbaa !23
  %138 = getelementptr inbounds %struct.log, %struct.log* %14, i64 0, i32 4, i64 4
  store i8 %137, i8* %138, align 4, !tbaa !23
  %139 = load i8, i8* %56, align 1, !tbaa !23
  %140 = getelementptr inbounds %struct.log, %struct.log* %14, i64 0, i32 4, i64 5
  store i8 %139, i8* %140, align 1, !tbaa !23
  %141 = call i64 inttoptr (i64 5 to i64 ()*)() #2
  store i64 %141, i64* %11, align 8, !tbaa !2
  %142 = call i32 inttoptr (i64 2 to i32 (i8*, i8*, i8*, i64)*)(i8* bitcast (%struct.bpf_map_def* @logs to i8*), i8* nonnull %21, i8* nonnull %121, i64 0) #2
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %121) #2
  br label %667
...
; <label>:667:                                    ; preds = %40, %665, %120, %77
  %668 = phi i32 [ 1, %77 ], [ 2, %120 ], [ %666, %665 ], [ 1, %40 ]
